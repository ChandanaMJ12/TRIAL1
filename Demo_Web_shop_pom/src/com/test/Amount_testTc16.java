...
public class Amount_testTc16 extends Browser_setup{
	...
	System.out.println(sc.Quantity.getAttribute("value"));
	assertTrue(sc.Quantity.getAttribute("value").equalsIgnoreCase(value),"User is not able to change quantity");
