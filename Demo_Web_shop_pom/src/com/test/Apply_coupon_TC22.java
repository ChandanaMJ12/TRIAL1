...
public class Apply_coupon_TC22 extends Browser_setup{
	@DataProvider(name="testdata")
	public Object[][] Testdata() throws IOException
	{
		Object[][] data=Utility_fun.Test_data("Sheet8");
		return data;
	}
	@Test(dataProvider="testdata")
	public void test(String Email,String Pwd,String value,String coupon) throws InterruptedException{
